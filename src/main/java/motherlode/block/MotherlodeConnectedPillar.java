...
import static motherlode.block.MotherlodeConnectedPillar.PairHelper.getFacingFromPropertyWithAxis;

@MethodsReturnNonnullByDefault
@ParametersAreNonnullByDefault
public abstract class MotherlodeConnectedPillar extends BlockRotatedPillar {
    protected final int boundingBoxLower;
    protected final int boundingBoxUpper;


    MotherlodeConnectedPillar(Material materialIn, int boundingBoxLower, int boundingBoxUpper) {
        super(materialIn);
